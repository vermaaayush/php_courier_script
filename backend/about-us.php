...
<head>
    <title>Find out all About Us | PT. Rizky Global Persada </title>
...
<main class="slide">
	...
	<div class="fw about-header-bg"></div>

	<div class="fw">
		<section class="about-us-features">
			<div class="col-md-6 col-sm-12 noPadLeft industryLeading">
				<header>
					<h2>Company Overview</h2>
				</header>
					<p><img src="deprixa_components/images/industry-leading.png" align="left" alt=""></p>
					<p>PT. Rizky Global Persada offers authentic and cost-effective freight shipping solutions for cargo transportation and transport logistics services worldwide. Our transport logistics services include air freight, sea freight and Land freight.We have a dedicated team of highly trained freight shipping specialists, structured to provide our customers with a competitive edge. Our solid infrastructure of global freight management supports international freight shipping that is focused on our core competency, versatility in accommodating each customers special handling and freight shipping requirements.</p>
			</div>
			<div class="col-md-6">
