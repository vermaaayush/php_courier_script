<?php
	...
	header("Content-Disposition: attachment; filename=Shipments_cash_payment.xls");
...
<title><?php echo $company['cname']; ?> | <?php echo $enviospagoefectivo; ?></title>
<style type="text/css"> 
	<!-- 
	.estilo1 { 
	...
	<body>
		...
		<main>
			<table width="50%" border="1">
				  <tr>
					<td colspan="7" class="estilo4"><CENTER><strong> <h1><?php echo $enviospagoefectivo; ?></h1></strong></CENTER></td>
				  </tr>
				...
				<?php
					...
					$sql=mysql_query("SELECT cid,tracking,pick_time,book_date,ship_name,rev_name,r_phone,status FROM courier WHERE book_mode = 'Effective'  AND officename='".$_SESSION["user_type"]."' AND book_date   BETWEEN '$desde' AND '$hasta'");
