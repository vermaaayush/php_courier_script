			...
			<table ui-jq="dataTable" class="table table-striped b-t b-b">
				...
				<tbody>
				  <tr>
					  ...
					  <td align="center"><a data-target="#update_price<?php echo $row['cid']; ?>" data-toggle="modal">
					  <img src="img/dollar.png"  height="20" width="20"></a></td>		
...
<?php include("modal-status/update_pricing.php"); ?>
