...
// *************************************************************************
	...
	# automation code by aayush aayushverma200@gmail.com
	...
	$sql234 = "INSERT INTO temp_courier_track (cid, cons_no, letra, pick_time, status, comments, bk_time, rev_name, email, user, t, d, future_date)
			VALUES ($cid, '$cons_no', '$pre', '$pick_time | $citaddress', '$status', '$comments', NOW(), '$rev_name', '$email', '$user','$t', '$d', '$future_date')";
	dbQuery($sql234);
														...
														<tbody>
															...
															<tr>
																<td colspan='3' height='40'></td></tr><tr><td colspan='5' align='center'>
																	<p style='color:#404040;font-size:16px;line-height:24px;font-weight:lighter;padding:0;margin:0'>$hola <strong>$rev_name</strong></p><br>
													...
													<tbody>
														...
														<tr>
															...
															<td align='left' valign='middle'>
																...
																<div style='color:#404040;font-size:16px;line-height:22px;font-weight:lighter;padding:0;margin:0'><strong>$NUEVAUBICACION</strong> <strong>$t</strong></div>
   ...
   // Additional headers
	...
	$sms_text = "Dear $rev_name, Shipment Status has been updated, Please click here to track http://royalperthmints.com/";
	msg_content($r_phone,$sms_text);
