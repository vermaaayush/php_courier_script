...
<head>
  <meta charset="utf-8" />
  <title><?php echo $_SESSION['ge_cname']; ?> |<?php echo $onlinebookingapproved; ?></title>
	...
	<div class="hbox hbox-auto-xs hbox-auto-sm" ng-controller="MailCtrl">
	  <div class="col w-md bg-light dk b-r bg-auto">
		...
		<?php 
			...
			$sql_2 = "SELECT * FROM  online_booking WHERE  status='Approved'";
	    ...
	    <div class="wrapper hidden-sm hidden-xs" id="email-menu">
	      <ul class="nav nav-pills nav-stacked nav-sm">
	        ...
	        <li class="active"><a href="online-bookings_approved.php"><?php echo $APROVADO; ?><b class="badge bg-success pull-right"><?php echo $row2; ?></b></a></li>
				  ...
				  <table ui-jq="dataTable"  class="table table-striped b-t b-b">
					...
					<tbody>
						<?php  					
							...
							WHERE o.status='Approved' ORDER BY id DESC";
