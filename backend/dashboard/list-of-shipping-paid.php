...
<head>
  <meta charset="utf-8" />
  <title><?php echo $_SESSION['ge_cname']; ?> | <?php echo $listapagados; ?></title>
      ...
      <div class="panel hbox hbox-auto-xs no-border">
		...
		<div class="col-sm-12">
			<div class="card-box table-responsive">
					<h4 class="header-title m-t-0 m-b-20"><?php echo $listapagadosefectivo; ?></h4>
				<table border="0" align="center">
					<tr>				
						...
						<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a target="_blank" href="javascript:reportpaidPDF();"><img src="img/pdf.png" alt="x" border="0" height="35" width="26" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a target="_blank" href="javascript:reportpaidEXCEL();"><img src="img/excel.png" alt="x" border="0" height="35" width="26" /></a>
						</td>
					</tr>
				</table>
				</br>
				   <table ui-jq="dataTable"  class="table table-striped b-t b-b">				  
					...
					<tbody>
					<?php  					
						$result3 = mysql_query("SELECT * FROM courier WHERE book_mode = 'Effective'  ORDER BY cid");
					...
					<tbody>
					<?php  					
						$result3 = mysql_query("SELECT * FROM courier WHERE book_mode = 'Effective' and officename='".$_SESSION["user_type"]."' ORDER BY cid");
						while($row = mysql_fetch_array($result3)) {					
					?> 
					  <tr>							  
								  <td align="center">
...
<script src="js/reportepaid.js"></script>
<script src="js/reportepaidship.js"></script>
