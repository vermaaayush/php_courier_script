...
<head>
    <title>Refund Policy | PT. Rizky Global Persada </title>
...
<main class="slide">
	...
	<div class="fw col-lg-12">
		...
		<h1>Refund Policy</h1>
		<br><br>
		<p>You have 30 days from your invoice date to initiate a return. Should you wish to return a product, please follow the steps below</p>
		<ol>
		<li><span></span> Call one of our Return Specialists at 1-800-347-890; Monday–Friday: 6 am – 4 pm (Arizona Time). Please provide your Customer ID and the reason for the return.</li>
		<li><span></span>The Return Specialist will give you a Return Merchandise Authorization (RMA) number and an address for the return</li>
		<li><span></span>Ship your return through Registered Mail using a tracking number to ensure we receive the product. We are not responsible for lost return shipments.</li>
		<li><span></span>After we have received and approved your return, you will be credited the refund on the credit card or method of payment used to purchase the order.</li>
		<li><span></span>Processing of returns may take up to 30 days. Shipping fees are non-refundable. Reimbursement will be made for the value of the original product order less a 12% restocking fee.</li>
