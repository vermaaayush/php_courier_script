...
<head>
	<meta charset="utf-8">
    <title>Bank Details | PT. Rizky Global Persada </title>
...
<section class="get-in-touch">
	...
	<div class="col-lg-4 col-sm-4 col-sm-offset-2">
			<p class="info">
<p><strong>Bank name </strong> : BANK MANDIRI branch Pondok Cabe Mutiara </p>

<p><strong>Bank address</strong> : Pondok Cabe Tangerang Selatan</p>


<p><strong>Beneficiary address</strong> : Pamulang Tangerang</p>

<p><strong>Account no</strong> : 1640002089508</p>

<p><strong>Swift code</strong>: BMRI IDJA</p>
			</p>
		</div>
	</div>
