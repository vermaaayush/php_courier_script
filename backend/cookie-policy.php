...
<head>
    <title>Cookie Policy | PT. Rizky Global Persada </title>
...
<div class="fw col-lg-12">
	...
	<p><span>cookie (also called web cookie, Internet cookie, browser cookie or simply cookie) is a small piece of data sent from a website and stored on the user's computer by the user's web browser while the user is browsing. Cookies were designed to be a reliable mechanism for websites to remember stateful information.</span></p>
	<p><strong><span>Why are cookies needed on My Parcel Delivery?</span></strong></p>
	<p>We use cookies on our website. Cookies are used to improve the functionality and use of our internet site, as well as for analytic and advertising purposes<span> </span><strong><span>None of the cookies used on our websites collect personally identifiable information about you.</span></strong></span></p>
	<p><strong>Cookies that we use. </strong></p>
	<p><em>Tracking cookies -</em> are commonly used as ways to compile long-term records of individuals' browsing histories.</p>
	<p><em>Authentication cookies</em> - are the most common method used by web servers to know whether the user is logged in or not, and which account they are logged in with.</p>
	<p><em>Secure cookies</em> - can only be transmitted over an encrypted connection (i.e. HTTPS). They cannot be transmitted over unencrypted connections (i.e. HTTP). This makes the cookie less likely to be exposed to cookie theft via eavesdropping.</p>
	</section>
</div>
